...
public static class DependencyInjection
{
    ...
    public static IServiceCollection AddAppRateLimiting(this IServiceCollection services)
    {
        ...
        {
            options.AddSlidingWindowLimiter("SlidingWindow", limiteropOptions =>
            {
                limiteropOptions.PermitLimit = 100;
                limiteropOptions.Window = TimeSpan.FromMinutes(1);
                limiteropOptions.SegmentsPerWindow = 6;
                limiteropOptions.QueueLimit = 10;
                limiteropOptions.QueueProcessingOrder = QueueProcessingOrder.OldestFirst;
                limiteropOptions.AutoReplenishment = true;
            });
    ...
    public static IServiceCollection AddConfiguredCors(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddCors(options => options.AddPolicy(
            ...
            policy => policy.WithOrigins(appSettings.AllowedOrigins)
                            .AllowAnyHeader()
                            .AllowAnyMethod()
                            .AllowCredentials()
        ));
